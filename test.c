...
// VIDEO_FORMAT = atoi(argv[3]);
    ...
    // 开始录制
   // printf("Being Capture one frame\n");
    enum v4l2_buf_type type = V4L2_BUF_TYPE_VIDEO_CAPTURE;
    ret = ioctl(fd, VIDIOC_STREAMON, &type);
   // printf("End Capture one frame\n ");
    if (ret < 0) {
